...
from .views import productdetail, projects_tek,ankara_dijital_baski,ankara_uv_baski,ankara_web_tasarimi, ankara_display_urunleri ,ankara_tabela_sistemleri , ankara_promosyon_urunleri , ankara_matbaa_hizmetleri,ankara_matbaa_hizmetleri,ankara_web_tasarimi,productdetail


urlpatterns = [
    path('', projects_tek, name="projects"),
    path('ankara-dijital-baski/', ankara_dijital_baski, name="ankara_dijital_baski"),
    path('ankara-uv-baski/', ankara_uv_baski, name="ankara_uv_baski"),
